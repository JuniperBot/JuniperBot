...
## Version 6.7
 ...
 - **[audio]** Боты и заглушенные модераторами участники теперь не считаются слушателями и бот остановит воспроизведение музыки по истечении времени из-за отсутствия слушателей
 ...
 - **[bonus]** Nitro Booster'ы сервера поддержки получают бонусные возможности
