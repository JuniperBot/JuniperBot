...
## Version 6.8
 ...
 - **[moderation]** Действия за предупреждения теперь закицлены. При достижении последнего уровня предупреждений, старые предупреждения сбрасываются и подсчёт начинается сначала.
