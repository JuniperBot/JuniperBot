...
## Version 7.6
 ...
 - Исправлен конфликт выдачи ролей по голосовой связи (роль в голосовом канале и наградная роль за опыт);
 - Роль мьюта теперь добавляет свои права в категориях каналов;
