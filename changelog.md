...
## Version 6.5
 - Возможность отключения цифрового помощника (болталки) в основных настройках бота
 - Команда `цвет` теперь должна правильно определять положение новой цветной роли в списке ролей
 - Возможность отключения автообновления панели воспроизведения музыки (прогресс)
 - Возможность указания прямой ссылки на канал при создании подписки на YouTube
 - Недоступные для добавления роли теперь отображаются с соответствующим советом переместить роль бота выше
