 ...
 */
package ru.caramel.juniperbot.modules.vk.persistence.service;
...
import ru.caramel.juniperbot.modules.webhook.model.WebHookMessage;
...
import ru.caramel.juniperbot.modules.vk.persistence.repository.VkConnectionRepository;
import ru.caramel.juniperbot.modules.webhook.persistence.repository.WebHookRepository;
...
import static ru.caramel.juniperbot.core.utils.CommonUtils.coalesce;
import static ru.caramel.juniperbot.core.utils.CommonUtils.trimTo;
import static ru.caramel.juniperbot.core.utils.CommonUtils.mdLink;
...
public class VkServiceImpl implements VkService {
    ...
    public void post(VkConnection connection, CallbackMessage<CallbackWallPost> message) {
        ...
        discordService.executeWebHook(connection.getWebHook(), createMessage(message), e -> {
            e.setEnabled(false);
